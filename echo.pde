...
void setup(){
  size(512, 512);
background(255);
  Element c = new Circle(100,100,50,50,color(255,0,0),color(255), 0);
  elements.add(c);
  elements.get(elements.size()-1).setType(Type.Circle);
  Element s = new Square(200,100,50,50,color(25,200,50),color(0), 3);
  elements.add(s);
